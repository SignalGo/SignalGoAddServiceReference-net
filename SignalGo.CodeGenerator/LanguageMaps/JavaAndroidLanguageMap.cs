...
namespace SignalGo.CodeGenerator.LanguageMaps
{
    ...
    public class JavaAndroidLanguageMap
    {
        ...
        public string GetFileNameFromClassName(string name)
        {
            ...
            return generic.Name.ToString() + ".java";
        }
...
@Injectable({{
  providedIn: 'root'
        ...
        {
            builder.AppendLine("package " + enumReferenceInfo.NameSpace + ";");//+ " : " + enumReferenceInfo.TypeName
            builder.AppendLine();
            builder.AppendLine("enum " + enumReferenceInfo.Name + " {");//+ " : " + enumReferenceInfo.TypeName
    ...
    private FailedReasonType(String toString, int value) {
    ...
    public String toString() {
        ...
        private void GenerateModelClass(ClassReferenceInfo classReferenceInfo, string prefix, StringBuilder builder, MapDataClassInfo mapDataClassInfo, string baseServiceName, Dictionary<string, Dictionary<string, string>> nameSpaces)
        {
            ...
            baseName += " implements Parcelable";
            builder.AppendLine(prefix + "public class " + classReferenceInfo.Name + baseName + "{");
            builder.AppendLine($@"    public static final Creator<{classReferenceInfo.Name}> CREATOR = new Creator<{classReferenceInfo.Name}>() {{
        @Override
        public {classReferenceInfo.Name} createFromParcel(Parcel in) {{
            return new {classReferenceInfo.Name}(in);
        }}

        @Override
        public {classReferenceInfo.Name}[] newArray(int size) {{
            return new {classReferenceInfo.Name}[size];
        }}
    }};");
            builder.AppendLine($@"public {classReferenceInfo.Name}() {{}}");
